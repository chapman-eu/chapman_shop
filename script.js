...
const PRODUCTS = [
  // CHERRY
  { id: "cherry-kingsize-single",  name: "Chapman KINGSIZE Cherry",        price: 14, oldPrice: 17.5, img: "img/kingsize_cherry.png",        inStock: true, isNew: true },
  { id: "cherry-compact-single",  name: "Chapman Compact Cherry",        price: 12, oldPrice: 13.5, img: "img/compact_cherry.png",        inStock: true, isNew: false },
  { id: "cherry-slims-single",    name: "Chapman Slims Cherry",          price: 9, oldPrice: 13, img: "img/slims_cherry.png",          inStock: false, isNew: true },
  { id: "cherry-compact-x10",     name: "Chapman Compact Cherry (x10)",  price: 115, oldPrice: 120, img: "img/compact_cherry_x10.png",    inStock: true, isNew: false },
  { id: "cherry-slims-x10",       name: "Chapman Slims Cherry (x10)",    price: 85, oldPrice: 110, img: "img/slims_cherry_x10.png",      inStock: false, isNew: true },
  { id: "cherry-kingsize-x10",       name: "Chapman KINGSIZE Cherry (x10)",    price: 125, oldPrice: 130, img: "img/kingsize_cherry_x10.png",      inStock: true, isNew: true },

  // BROWN
  { id: "brown-kingsize-single",   name: "Chapman KINGSIZE Brown",         price: 14, oldPrice: 15, img: "img/kingsize_brown.png",         inStock: true, isNew: true },
  { id: "brown-compact-single",   name: "Chapman Compact Brown",         price: 12, oldPrice: 13.5, img: "img/compact_brown.png",         inStock: true, isNew: true },
  { id: "brown-compact-x10",      name: "Chapman Compact Brown (x10)",   price: 115, oldPrice: 120, img: "img/compact_brown_x10.png",     inStock: true, isNew: false },
  ...
  { id: "vanilla-slims-single",   name: "Chapman Slims Vanilla",         price: 10, oldPrice: 13, img: "img/slims_vanilla.png",         inStock: false, isNew: true },
  { id: "vanilla-slims-x10",      name: "Chapman Slims Vanilla (x10)",   price: 95, oldPrice: 110, img: "img/slims_vanilla_x10.png",     inStock: false, isNew: true },
  { id: "vanilla-kingsize-x10",      name: "Chapman KINGSIZE Vanilla (x10)",   price: 115, oldPrice: 125, img: "img/kingsize_vanilla_x10.png",     inStock: false, isNew: false },
  ...
  { id: "green-slims-x10",        name: "Chapman Slims Green (x10)",     price: 85, oldPrice: 100, img: "img/slims_green_x10.png",       inStock: false, isNew: true },
     ...
     // CLASSIC
  { id: "classic-slims-single",     name: "Chapman Slims Classic",           price: 10, oldPrice: 13, img: "img/slims_classic.png",           inStock: false, isNew: true },
  { id: "classic-slims-x10",        name: "Chapman Slims Classic (x10)",     price: 95, oldPrice: 110, img: "img/slims_classic_x10.png",       inStock: false, isNew: true }
];
...
function renderProducts(){
  ...
  PRODUCTS.forEach(p=>{
    ...
    const outBadge = !p.inStock ? '<div class="badge out">OUT OF STOCK</div>' : '';
    const newBadge = p.isNew ? '<div class="badge new">NEW</div>' : '';
    ...
    card.innerHTML = `
      ...
      <div class="meta">
        ...
        <div class="price">
          ${formatEUR(p.price)}
          ${p.oldPrice && p.oldPrice > p.price ? `<span class="old-price">${formatEUR(p.oldPrice)}</span>` : ''}
        </div>
      </div>
